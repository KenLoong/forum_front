            ...
            <div class="container">
                ...
                <el-menu
                    ...
                    <el-menu-item index="2">
                        <router-link class="text-primary" :to="{name:'Followers',params:{userId:user.id}}">
                            <span v-text="user.username"></span>的粉丝
                        </router-link>
                    </el-menu-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            page(currentPage) {
                const _this = this
                _this.$axios.get("/followees/"+_this.$route.params.userId+"?currentPage=" + currentPage).then(res => {
                    const myData = res.data.data;
                    _this.user = myData.user;
                    _this.userList = myData.userList;
                    _this.total = myData.total;
